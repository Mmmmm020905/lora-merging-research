...
def compute_metrics(eval_pred):
    ...
    tokenizer = AutoTokenizer.from_pretrained("/data2/centrai/mizijie_intern/IterIS-merging-main/flan-t5-base")
...
def main():
    ...
    local_model_path = "/data2/centrai/mizijie_intern/IterIS-merging-main/flan-t5-base"
    ...
    local_glue_root = os.path.expanduser("/data2/centrai/mizijie_intern/IterIS-merging-main/glue_local")
    local_task_path = os.path.join(local_glue_root, task_actual)
    ...
    model = T5ForConditionalGeneration.from_pretrained(local_model_path, max_length=256)
    ...
    with open(os.path.join(best_model_dir, "best_model_info.yaml"), "w") as f:
        yaml.safe_dump(best_info, f)
